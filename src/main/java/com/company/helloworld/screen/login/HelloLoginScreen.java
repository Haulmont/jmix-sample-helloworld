package com.company.helloworld.screen.login;
...
@UiController("hello_LoginScreen")
@UiDescriptor("hello-login-screen.xml")
@Route(path = "login", root = true)
public class HelloLoginScreen extends Screen {
